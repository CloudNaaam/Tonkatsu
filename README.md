...
|:------------------------------------:|:------------------------------------:|:------------------------------------:|:------------------------------------:|:------------------------------------:|
| URL 문자열 내에서 - 문자의 개수 추출 | URL 문자열 내에서 ? 문자의 개수 추출 | URL 문자열 내에서 / 문자의 개수 추출 | URL 문자열 내에서 = 문자의 개수 추출 | URL 문자열 내에서 . 문자의 개수 추출 |
|            **URL_length**            |            **PATH_length**           |                                      |                                      |                                      |
|           URL의 길이 비교            |         URL의 PATH 길이 비교         |                                      |                                      |                                      |
|           **URL_has_file**           |             **use_of_IP**            |              **entropy**             |          **dom_ALEXA_rank**          |                                      |
|  URL 문자열 내 파일 확장자 포함 여부 |     도메인 문자열 내 IP 포함 여부    |       문자열의 엔트로피 값 추출      |       도메인의 ALEXA 순위 유무       |                                      |
